        ...
        if (offset_reset_ <= 0){
            ...
            if (!(c < 27))
            {
                ...
                else
                {
                    ...
                    // msg.wrench.force.x = (data[0] - 8192) ;
                    // msg.wrench.force.y = (data[1] - 8192) ;
                    // msg.wrench.force.z = (data[2] - 8192) ;
                    // msg.wrench.torque.x = (data[3] - 8192);
                    // msg.wrench.torque.y = (data[4] - 8192);
                    // msg.wrench.torque.z = (data[5] - 8192);


                    msg.wrench.force.x  = data[0] * 0.0;
                    msg.wrench.force.y  = data[1] * 0.0;
