...
class Test:
    ...
    def read_data(self):
        # return self._change_moment_unit_of_sensitivities(self._read_data())
    ...
    def main(self):
        with serial.Serial(port='/dev/ttyUSB0',
                           ...
                           stopbits = serial.STOPBITS_ONE ) as self.ser:




            sensitivities = self.read_sensitivity()
            self.print_sensitivities(sensitivities)
